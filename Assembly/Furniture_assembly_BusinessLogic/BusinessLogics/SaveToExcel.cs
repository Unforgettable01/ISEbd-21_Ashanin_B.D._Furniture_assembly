    ...
    public static class SaveToExcel
    {
        public static void CreateDoc(ExcelInfo info)
        {
             ...
             SpreadsheetDocument.Create(info.FileName, SpreadsheetDocumentType.Workbook))
            {
                ...
                uint rowIndex = 2;
                foreach (var  furnitureComponent in info.FurnitureComponents)
                {
                    InsertCellInWorksheet(new ExcelCellParameters
                    {
                        Worksheet = worksheetPart.Worksheet,
                        ...
                        ColumnName = "A",
                        RowIndex = rowIndex,
                        Text = furnitureComponent.FurnitureName,
                        StyleIndex = 0U
                    });
                    rowIndex++;

                    foreach (var furniture in furnitureComponent.Components)
                    {
                        InsertCellInWorksheet(new ExcelCellParameters
                        {
                            Worksheet = worksheetPart.Worksheet,
                    ...
                    InsertCellInWorksheet(new ExcelCellParameters
                    {
                        ...
                        ColumnName = "C",
                        RowIndex = rowIndex,
                        Text = furnitureComponent.TotalCount.ToString(),
                        StyleIndex = 0U
                    });
                    rowIndex++;
                }
